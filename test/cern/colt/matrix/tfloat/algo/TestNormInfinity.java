...
class TestNormInfinity {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(FloatAlgebra.DEFAULT.normInfinity(x1));
        System.out.println(FloatAlgebra.DEFAULT.normInfinity(x2));
        System.out.println(FloatAlgebra.DEFAULT.normInfinity(x3));
    }
}