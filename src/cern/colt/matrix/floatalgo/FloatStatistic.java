...
public class FloatStatistic extends Object {
     ...
     * @return <tt>histo</tt> (for convenience only).
     */
    public static hep.aida.FloatIHistogram1D histogram(final hep.aida.FloatIHistogram1D histo, final FloatMatrix2D matrix) {
        histo.fill_2D((float[]) matrix.elements(), matrix.rows(), matrix.columns(), matrix.index(0, 0), matrix.rowStride(), matrix.columnStride());
        return histo;
    }
     ...
     * @return <tt>histo</tt> (for convenience only).
     */
    public static hep.aida.FloatIHistogram1D[][] histogram(final hep.aida.FloatIHistogram1D[][] histo, final FloatMatrix2D matrix, final int m, final int n) {
        int rows = matrix.rows();
                    ...
                    public void run() {
                        ...
                        for (int r = startrow; r < stoprow; r++) {
                            for (int c = 0; c < n; c++) {
                                ...
                                histo[r][c].fill_2D((float[]) view.elements(), view.rows(), view.columns(), view.index(0, 0), view.rowStride(), view.columnStride());
                            }
                        }
                    }
                });
