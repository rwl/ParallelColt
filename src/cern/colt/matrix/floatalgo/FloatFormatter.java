...
public class FloatFormatter extends AbstractFormatter {
    ...
    public static void demo5() {
        ...
        System.out.println(new FloatFormatter("%G").toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
    }
    ...
    public static void demo6() {
        ...
        System.out.println(new FloatFormatter().toString(cern.colt.matrix.FloatFactory2D.dense.make(values)));
        System.out.println(new FloatFormatter().toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
    }
    ...
    public static void demo7() {
        ...
        System.out.println(new FloatFormatter(format).toTitleString(cern.colt.matrix.FloatFactory2D.dense.make(values), rowNames, columnNames, rowAxisName, columnAxisName, title, aggr));
    ...
    public String toTitleString(FloatMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title, hep.aida.bin.FloatBinFunction1D[] aggr) {
        ...
        cern.colt.matrix.floatalgo.FloatStatistic.aggregate(matrix, aggr, colStats); // aggregate
        // an
        // entire
        // column
        // at a
        // time
        cern.colt.matrix.floatalgo.FloatStatistic.aggregate(matrix.viewDice(), aggr, rowStats.viewDice()); // aggregate
        // an
        // entire
        // row
        // at a
