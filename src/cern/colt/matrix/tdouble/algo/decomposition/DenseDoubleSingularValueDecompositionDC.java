 ...
 * 
 */
public class DenseDoubleSingularValueDecompositionDC {
     ...
     */
    public DenseDoubleSingularValueDecompositionDC(DoubleMatrix2D A, boolean wantUV, boolean wantWholeUV) {
