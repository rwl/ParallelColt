...
class SelectedSparseDoubleMatrix2D extends DoubleMatrix2D {
     ...
     * @param offset
     */
    protected SelectedSparseDoubleMatrix2D(AbstractLongDoubleMap elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedSparseDoubleMatrix2D(int rows, int columns, AbstractLongDoubleMap elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
