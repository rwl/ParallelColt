 ...
 * {@link cern.colt.list.tdouble.DoubleArrayList} to hold the column indexes and nonzero
 ...
 * </td>
 * </table> Method
 * {@link #assign(DoubleMatrix2D,cern.colt.function.tdouble.DoubleDoubleFunction)} does
 * just that if you supply {@link cern.jet.math.tdouble.DoubleFunctions#plusMult} as
 * argument.
 * 
 * 
...
public class RCDoubleMatrix2D extends WrapperDoubleMatrix2D {
    ...
    public DoubleMatrix2D assign(DoubleMatrix2D y, cern.colt.function.tdouble.DoubleDoubleFunction function) {
        checkShape(y);
