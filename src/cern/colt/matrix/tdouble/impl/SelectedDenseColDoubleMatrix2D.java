 ...
 */
class SelectedDenseColDoubleMatrix2D extends DoubleMatrix2D {
    /**
     ...
     * @param offset
     */
    protected SelectedDenseColDoubleMatrix2D(double[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseColDoubleMatrix2D(int rows, int columns, double[] elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * is an instance of type <tt>SparseColDoubleMatrix2D</tt> the new matrix
     ...
     * instance of type <tt>DenseColDoubleMatrix2D</tt> the new matrix must be of
    ...
    protected DoubleMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets) {
        return new SelectedDenseColDoubleMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset);
    }
}
