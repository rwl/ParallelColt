...
class RCMDoubleMatrix2D extends WrapperDoubleMatrix2D {
     ...
     */
    protected void zMult(final DoubleMatrix1D y, final DoubleMatrix1D z, cern.colt.list.tint.IntArrayList nonZeroIndexes, DoubleMatrix1D[] allRows, final double alpha, final double beta) {
