 ...
 * {@link cern.colt.list.tfloat.FloatArrayList} to hold the column indexes and nonzero
 ...
 * </td>
 * </table> Method
 * {@link #assign(FloatMatrix2D,cern.colt.function.tfloat.FloatFloatFunction)} does
 * just that if you supply {@link cern.jet.math.tfloat.FloatFunctions#plusMult} as
 * argument.
 * 
 * 
...
public class RCFloatMatrix2D extends WrapperFloatMatrix2D {
    ...
    public FloatMatrix2D assign(FloatMatrix2D y, cern.colt.function.tfloat.FloatFloatFunction function) {
        checkShape(y);
