...
/**
 * Selection view on dense 2-d matrices holding <tt>float</tt> elements.
 ...
 */
class SelectedDenseColFloatMatrix2D extends FloatMatrix2D {
    /**
     ...
     * @param offset
     */
    protected SelectedDenseColFloatMatrix2D(float[] elements, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * @param offset
     */
    protected SelectedDenseColFloatMatrix2D(int rows, int columns, float[] elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset) {
     ...
     * is an instance of type <tt>SparseColFloatMatrix2D</tt> the new matrix
     ...
     * type <tt>SparseColFloatMatrix2D</tt> the new matrix must be of type
    ...
    protected FloatMatrix2D viewSelectionLike(int[] rowOffsets, int[] columnOffsets) {
        return new SelectedDenseColFloatMatrix2D(this.elements, rowOffsets, columnOffsets, this.offset);
    }
}
