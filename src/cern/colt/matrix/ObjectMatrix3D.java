...
public abstract class ObjectMatrix3D extends AbstractMatrix3D {
     ...
     * 
     * @see cern.colt.matrix.objectalgo.ObjectFormatter
     */
    public String toString() {
        return new cern.colt.matrix.objectalgo.ObjectFormatter().toString(this);
    }
     ...
     * information, see
     * {@link cern.colt.matrix.objectalgo.ObjectSorting#sort(ObjectMatrix3D,int,int)}.
     * For more advanced sorting functionality, see
     * {@link cern.colt.matrix.objectalgo.ObjectSorting}.
     * 
    ...
    public ObjectMatrix3D viewSorted(int row, int column) {
        return cern.colt.matrix.objectalgo.ObjectSorting.mergeSort.sort(this, row, column);
    }
