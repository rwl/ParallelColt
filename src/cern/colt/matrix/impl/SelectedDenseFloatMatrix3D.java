...
/**
 * Selection view on dense 3-d matrices holding <tt>float</tt> elements.
...
class SelectedDenseFloatMatrix3D extends FloatMatrix3D {
     ...
     * be of type <tt>DenseFloatMatrix2D</tt>, if the receiver is an
     * instance of type <tt>SparseFloatMatrix3D</tt> the new matrix must also
     * be of type <tt>SparseFloatMatrix2D</tt>, etc.
     * 
     * @param rows
     *            the number of rows the matrix shall have.
     * @param columns
