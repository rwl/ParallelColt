...
public class DoubleFormatter extends AbstractFormatter {
    ...
    public static void demo5() {
        ...
        System.out.println(new DoubleFormatter("%G").toTitleString(cern.colt.matrix.DoubleFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
    }
    ...
    public static void demo6() {
        ...
        System.out.println(new DoubleFormatter().toString(cern.colt.matrix.DoubleFactory2D.dense.make(values)));
        System.out.println(new DoubleFormatter().toTitleString(cern.colt.matrix.DoubleFactory2D.dense.make(values), rowNames, columnNames, "vendor", "density", "title"));
    }
    ...
    public static void demo7() {
        ...
        System.out.println(new DoubleFormatter(format).toTitleString(cern.colt.matrix.DoubleFactory2D.dense.make(values), rowNames, columnNames, rowAxisName, columnAxisName, title, aggr));
    ...
    protected String toTitleString(DoubleMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title) {
        ...
        return new cern.colt.matrix.objectalgo.ObjectFormatter().toTitleString(cern.colt.matrix.ObjectFactory2D.dense.make(s), rowNames, columnNames, rowAxisName, columnAxisName, title);
    }
    ...
    public String toTitleString(DoubleMatrix2D matrix, String[] rowNames, String[] columnNames, String rowAxisName, String columnAxisName, String title, hep.aida.bin.DoubleBinFunction1D[] aggr) {
        ...
        cern.colt.matrix.doublealgo.DoubleStatistic.aggregate(matrix, aggr, colStats); // aggregate
        // an
        // entire
        // column
        // at a
        // time
        cern.colt.matrix.doublealgo.DoubleStatistic.aggregate(matrix.viewDice(), aggr, rowStats.viewDice()); // aggregate
        // an
        // entire
        // row
        // at a
        ...
        String s = new cern.colt.matrix.objectalgo.ObjectFormatter().toTitleString(allStats, rowNames, columnNames, rowAxisName, columnAxisName, title);
