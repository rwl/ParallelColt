...
public class DoubleStatistic extends Object {
     ...
     * @return <tt>histo</tt> (for convenience only).
     */
    public static hep.aida.DoubleIHistogram1D histogram(final hep.aida.DoubleIHistogram1D histo, final DoubleMatrix2D matrix) {
     ...
     * @return <tt>histo</tt> (for convenience only).
     */
    public static hep.aida.DoubleIHistogram1D[][] histogram(final hep.aida.DoubleIHistogram1D[][] histo, final DoubleMatrix2D matrix, final int m, final int n) {
        int rows = matrix.rows();
