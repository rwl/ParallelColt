...
/**
 * Selection view on sparse 3-d matrices holding <tt>int</tt> elements.
...
class SelectedSparseIntMatrix3D extends IntMatrix3D {
     ...
     */
    protected SelectedSparseIntMatrix3D(AbstractIntIntMap elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset) {
    ...
    public IntMatrix2D viewColumn(int column) {
        ...
        return new SelectedSparseIntMatrix2D(viewRows, viewColumns, this.elements, viewRowZero, viewColumnZero, viewRowStride, viewColumnStride, viewRowOffsets, viewColumnOffsets, viewOffset);
    }
     ...
     * instance of type <tt>DenseIntMatrix3D</tt> the new matrix must also
     * be of type <tt>DenseIntMatrix2D</tt>, if the receiver is an
     * instance of type <tt>SparseIntMatrix3D</tt> the new matrix must also
     * be of type <tt>SparseIntMatrix2D</tt>, etc.
     * 
     * @param rows
     *            the number of rows the matrix shall have.
     * @param columns
