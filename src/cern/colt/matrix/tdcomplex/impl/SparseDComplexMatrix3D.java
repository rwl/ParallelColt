...
public class SparseDComplexMatrix3D extends DComplexMatrix3D {
    ...
    public double[] getQuick(int slice, int row, int column) {
        double[] elem = elements.get(sliceZero + slice * sliceStride + rowZero + row * rowStride + columnZero + column * columnStride);
        if (elem != null) {
    ...
    public DComplexMatrix1D vectorize() {
        DComplexMatrix1D v = new SparseDComplexMatrix1D(size());
