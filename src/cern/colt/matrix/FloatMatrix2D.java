...
public abstract class FloatMatrix2D extends AbstractMatrix2D {
     ...
     * @see cern.jet.math.FloatFunctions
     */
    public float aggregate(final cern.colt.function.FloatFloatFunction aggr, final cern.colt.function.FloatFunction f, final IntArrayList rowList, final IntArrayList columnList) {
        if (size() == 0)
            return Float.NaN;
     ...
     * @see cern.jet.math.FloatFunctions
     */
    public FloatMatrix2D assign(final FloatMatrix2D y, final cern.colt.function.FloatFloatFunction function, IntArrayList rowList, IntArrayList columnList) {
        checkShape(y);
        final int size = rowList.size();
        final int[] rowElements = rowList.elements();
        final int[] columnElements = columnList.elements();
     ...
     * {@link cern.colt.matrix.floatalgo.FloatSorting#sort(FloatMatrix2D,int)}. For
    ...
    public FloatMatrix2D viewSorted(int column) {
        return cern.colt.matrix.floatalgo.FloatSorting.mergeSort.sort(this, column);
    }
