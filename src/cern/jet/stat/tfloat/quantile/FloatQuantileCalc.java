    ...
    protected static long[] known_N_compute_B_and_K_quick(long N, float epsilon) {
        ...
        for (int b = 2; b <= maxBuffers; b++) {
            ...
            while (h <= maxHeight && // skip heights until x<=0
                    (h - 2) * ((float) Math.round(binomial(b + h - 2, h - 1))) - ((float) Math.round(binomial(b + h - 3, h - 3))) + ((float) Math.round(binomial(b + h - 3, h - 2))) - c > 0.0) {
                h++;
            }
            ...
            int hMax;
            if (h >= maxHeight && (h - 2) * ((float) Math.round(binomial(b + h - 2, h - 1))) - ((float) Math.round(binomial(b + h - 3, h - 3))) + ((float) Math.round(binomial(b + h - 3, h - 2))) - c > 0.0) {
        ...
        for (int b = 2; b <= maxBuffers; b++) {
            ...
            if (h > Integer.MIN_VALUE) {
                float value = ((float) Math.round(binomial(b + h - 2, h - 1)));
