...
/**
 * Computes 3D Discrete Hartley Transform (DHT) of real, single precision data. The
...
public class FloatDHT_3D {
    ...
    public FloatDHT_3D(int n1, int n2, int n3) {
        ...
        dhtn1 = new FloatDHT_1D(n1, ip, w);
        dhtn2 = new FloatDHT_1D(n2, ip, w);
        dhtn3 = new FloatDHT_1D(n3, ip, w);
