 ...
 * sizes of both dimensions must be power-of-two numbers. This is a parallel
...
public class FloatDCT_2D {
    ...
    public void inverse(float[] a, boolean scale) {
        ...
        if ((ConcurrencyUtils.getNumberOfProcessors() > 1) && (n1 * n2 >= ConcurrencyUtils.getThreadsBeginN_2D())) {
            ddxt2d_subth(1, a, scale);
            ddxt2d0_subth(1, a, scale);
        } else {
            ddxt2d_sub(1, a, scale);
