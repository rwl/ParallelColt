...
public class DoubleFFT_1D {
	...
	void radf4(final int ido, final int l1, final double in[], final int in_off, final double out[], final int out_off, final int offset) {
		final double hsqt2 = 0.7071067811865475;
		int i, k, ic;
	...
	//	   isign is +1 for backward and -1 for forward transforms
	//	  ----------------------------------------------------------------------*/
	//	void passf6(final int ido, final int l1, final double a[], final int offa, final double ch[], final int offch, final int offset, final int isign)
	//	/*isign==-1 for forward transform and+1 for backward transform*/
	//	{
	//		double tau = isign * Math.sqrt(3.0) / 2.0;
	//		int i, k;
	//		double ci2, ci3, ci4, ci5, di3, di4, di5, di2, cr2, cr3, cr5, cr4, ti1, tr1, ti2, ti3, ti4, ti5, dr3, dr4, dr5, dr2, tr2, tr3, tr4, tr5;
