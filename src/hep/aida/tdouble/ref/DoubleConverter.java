...
public class DoubleConverter {
    ...
    public String toString(DoubleIHistogram1D h) {
        ...
        cern.colt.matrix.tdouble.DoubleMatrix2D heights = new cern.colt.matrix.tdouble.impl.DenseDoubleMatrix2D(1, h.xAxis().bins());
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.tdouble.algo.DoubleFormatter().toTitleString(heights, yEdges, xEdges, rowAxisName, columnAxisName, null, aggr);
        /*
         * + sep + "Errors:" + sep + new
    ...
    public String toString(DoubleIHistogram2D h) {
        ...
        cern.colt.matrix.tdouble.DoubleMatrix2D heights = new cern.colt.matrix.tdouble.impl.DenseDoubleMatrix2D(toArrayHeights(h));
    ...
    public String toString(DoubleIHistogram3D h) {
        ...
        cern.colt.matrix.tdouble.DoubleMatrix3D heights = new cern.colt.matrix.tdouble.impl.DenseDoubleMatrix3D(toArrayHeights(h));
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.tdouble.algo.DoubleFormatter().toTitleString(heights, zEdges, yEdges, xEdges, sliceAxisName, rowAxisName, columnAxisName, "", aggr);
        /*
         * + sep + "Errors:" + sep + new
         * cern.colt.matrix.doublealgo.Formatter().toTitleString(
         * errors,yEdges,xEdges,rowAxisName,columnAxisName,null,aggr);
