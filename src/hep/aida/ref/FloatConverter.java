...
public class FloatConverter {
    ...
    public String toString(FloatIHistogram1D h) {
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.floatalgo.FloatFormatter().toTitleString(heights, yEdges, xEdges, rowAxisName, columnAxisName, null, aggr);
        /*
         * + sep + "Errors:" + sep + new
    ...
    public String toString(FloatIHistogram3D h) {
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.floatalgo.FloatFormatter().toTitleString(heights, zEdges, yEdges, xEdges, sliceAxisName, rowAxisName, columnAxisName, "", aggr);
        /*
         * + sep + "Errors:" + sep + new
         * cern.colt.matrix.floatalgo.Formatter().toTitleString(
         * errors,yEdges,xEdges,rowAxisName,columnAxisName,null,aggr);
