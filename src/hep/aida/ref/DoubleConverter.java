...
public class DoubleConverter {
    ...
    public String toString(DoubleIHistogram1D h) {
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.doublealgo.DoubleFormatter().toTitleString(heights, yEdges, xEdges, rowAxisName, columnAxisName, null, aggr);
        /*
         * + sep + "Errors:" + sep + new
    ...
    public String toString(DoubleIHistogram3D h) {
        ...
        return title + sep + "Heights:" + sep + new cern.colt.matrix.doublealgo.DoubleFormatter().toTitleString(heights, zEdges, yEdges, xEdges, sliceAxisName, rowAxisName, columnAxisName, "", aggr);
        /*
         * + sep + "Errors:" + sep + new
         * cern.colt.matrix.doublealgo.Formatter().toTitleString(
         * errors,yEdges,xEdges,rowAxisName,columnAxisName,null,aggr);
