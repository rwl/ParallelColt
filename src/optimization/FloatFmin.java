...
public class FloatFmin extends Object {
     ...
     *            example of such a class. f_to_minimize must have one float
     *            valued argument.
     *@param tol
    ...
    public static float fmin(float a, float b, FloatFmin_methods minclass, float tol) {
        ...
        */
        ...
        float c, d, e, eps, xm, p, q, r, tol1, t2, u, v, w, fu, fv, fw, fx, x, tol3;

        c = (float) (.5 * (3.0 - Math.sqrt(5.0)));
        d = 0.0f;

        // 1.1921e-7 is machine precision
